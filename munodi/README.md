>> A Munodi sequence is a sequence of integer numbers  where C[n+1]=C[n]/2 if C[n] is even or C[n+1]=3*C[n]+1  if C[n] is odd. The sequence teminates when 1 appears.
